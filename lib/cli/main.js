...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ufocore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ufocore-node add wallet-service');
      console.log('    $ ufocore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ufocore-node remove wallet-service');
      console.log('    $ ufocore-node remove insight-api');
      console.log();
    });
